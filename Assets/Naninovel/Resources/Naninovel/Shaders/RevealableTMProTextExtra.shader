...
Shader "Naninovel/RevealableTMProText (Extra Effects)"
{
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            // -------------- Naninovel font. --------------
            // -------------- START INCLUDE TMPro_Properties.cginc --------------
            ...
            // -------------- END INCLUDE TMPro_Properties.cginc --------------
            // -------------- START INCLUDE TMPro.cginc --------------
            ...
            faceColor *= IsPositionOutsideRect(input.worldPos.xy, _LineClipRect);
            ...
            if (input.worldPos.y < _CharClipRect.w)
            {
                ...
                faceColor *= saturate(distance / _CharFadeWidth);
            }
            // ---------------------------------------------
    ...
    Fallback "Naninovel/RevealableTMProText"
